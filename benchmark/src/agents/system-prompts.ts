...
You have access to a MEMORY SYSTEM via MCP tools. Use them to:
...
- BEFORE starting work, browse existing memory to see what already exists
- AFTER completing work, store a summary of what was decided and changed
- Follow the tool usage instructions in the Custom Instructions section below
